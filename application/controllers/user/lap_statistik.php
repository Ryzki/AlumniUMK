...
class Lap_statistik extends CI_Controller{
	function __construct(){
		...
		$this->load->model('user/statistik_model');
	...
	public function index(){
		if($this->session->userdata('logged_in_umk')) {
			...
			$this->template_user->display('user/lapstatistik_v', $data);	    	
		} else {
	...
	public function preview() {		
		...
		$this->template_user->display('user/lapstatistikbyprogdi_v', $data);
	} 
}
/* Location: ./application/controllers/user/lap_statistik.php */
?>