<section class="wrapper"> 
                ...
                <div class="col-lg-12">                    
                    <div class="alert alert-success fade in">
                        ...
                        <ul>
                            ...
                            <li>4. <b>INI BUKAN FORM PENDAFTARAN WISUDA</b>, Silahkan ke : <a href='<?php echo site_url('wisuda/daftar'); ?>'><b>SINI</b></a> untuk Daftar Wisuda.</li>
                        </ul>
                        </p>
                    </div>                                            
                </div>
    ...
    <div class="row">
        ...
        <i class="icon-plus-sign-alt"></i> Form Pendaftaran Alumni
        </header>
        ...
        <div class="row">
            ...
            <section class="panel">
                ...
                <div class="panel-body">                           
                <form role="form" action="<?php echo site_url('daftar/savedata'); ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">

                    <div class="form-group has-success">
                        <label for="nim">N I M :</label>
                        <input type="text" class="form-control" name="nim" id="nim" size="9" maxlength="9" style="width:50%" placeholder="Enter NIM (999999999)" value="<?php echo set_value('nim'); ?>" autocomplete="off" required />
                        <p>*) <em>Username Anda</em></p>
                    </div>
                    <?php echo form_error('nim', '<div class="form-group has-error"><p class="help-block">','</p></div>'); ?>                     
                    <div class="form-group has-success">
                        <label for="nama">Nama Mahasiswa :</label>
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Enter Nama Anda" value="<?php echo set_value('nama'); ?>" autocomplete="off" required />
                    </div>
