                ...
                <div id="page-main">
                    <section class="events" id="events">
                        ...
                        <div class="section-content">
                            <?php                                 
                                foreach($daftar_info as $s) { 
                                    $tglx     = $s->penting_date_post; 
                            ...
                            <article class="event">
                                ...
                                <aside>
                                    <header>
                                        <a href="<?php echo site_url().'infopenting/id/'.$s->penting_id.'/'.$tahunx.'/'.$s->penting_seo; ?>"><?php echo $s->penting_title; ?></a>
                                    </header>                                    
                                    <div class="description">
                                        <p><?php echo $s->penting_short; ?></p>
                                    </div>
                                    <a href="<?php echo site_url().'infopenting/id/'.$s->penting_id.'/'.$tahunx.'/'.$s->penting_seo; ?>" class="btn btn-framed btn-color-grey btn-small">Detail</a>
                                </aside>
                            </article><!-- /article -->
                            <?php                                
                                } 
