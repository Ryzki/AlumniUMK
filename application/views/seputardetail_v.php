...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('seputar'); ?>">Seputar Alumni</a></li>
        <li class="active">Seputar Alumni Detail</li>
    </ol>
</div>
<!-- end Breadcrumb -->
            ...
            <div class="col-md-8">
                <div id="page-main">
                    <section id="blog-detail">
                        ...
                        <article class="blog-detail">
                            <header class="blog-detail-header">
                                <a href="<?php echo base_url(); ?>seputar_pict/<?php echo $detail->seputar_image; ?>" rel="prettyPhoto[1]">
                                <img src="<?php echo base_url(); ?>seputar_pict/<?php echo $detail->seputar_image; ?>" width="50%">
                                </a>
                                <h2><?php echo $detail->seputar_title ?></h2>
                                <?php 
                                    $tgl     = $detail->seputar_tgl_post;
                                ...
                                <div class="blog-detail-meta">
                                    ...
                                    <span class="author"><span class="fa fa-user"></span><?php echo $detail->user_username; ?></span>
                                    <span class="comments"><span class="fa fa-comment-o"></span><?php echo count($komentar);  ?> Komentar</span>
                                </div>
                            </header>
                            <hr>
                            <?php echo $detail->seputar_desc; ?>
                            <footer>
                                <section id="share-post">
                                    <div class="icons">
                                        <span>Share :</span>
                                        <div class="fb-share-button" data-href="<?php echo base_url().'seputar/id/'.$detail->seputar_id.'/'.$tahun.'/'.$detail->seputar_seo; ?>" data-layout="icon"></div>
                                    </div><!-- /.icons -->
                                </section><!-- /share -->                                
                            </footer>
                        </article>
                    ...
                    <section id="leave-reply">
                        ...
                        <form class="reply-form" action="<?php echo site_url().'seputar/kirim_komentar/'.$this->uri->segment(3).'/'.$this->uri->segment(4); ?>" method="post">
