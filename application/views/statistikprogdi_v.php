...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('statistik'); ?>">Statistik Alumni</a></li>
        <li class="active">Statistik Alumni by Program Studi</li>
    </ol>
</div>
<!-- end Breadcrumb -->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div id="page-main">
                    <section>
                        <article>
                            <header><h1>Statistik Alumni by Program Studi</h1></header>
                        </article>
                        <article>
                            <p align="justify">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">                            
                                        ...
                                        <select name="lstProgdi" id="lstProgdi" required>
                                            ...
                                            <?php foreach ($progdi as $x) { ?>                                    
                                            <option value="<?php echo $x->progdi_id; ?>"><?php echo $x->fakultas_name.' - '.$x->progdi_name; ?></option>
                                            <?php } ?>                                                        
                                        </select>                            
                                    </div>                                            
                    ...
                    <section>                        
                        <div align="center"><h3>STATISTIK TINGKAT KETERSERAPAN ALUMNI<br><?php echo strtoupper($namaprogdi->progdi_name).' Periode '.$this->input->post('tahun1', 'true').' s/d '.$this->input->post('tahun2', 'true'); ?></h3></div>
                        <fieldset>
                            <div id="canvasserapan"></div>
                        </fieldset>
                        <div align="center"><h3>STATISTIK KESESUAIAN BIDANG ILMU DENGAN PEKERJAAN<br><?php echo strtoupper($namaprogdi->progdi_name).' Periode '.$this->input->post('tahun1', 'true').' s/d '.$this->input->post('tahun2', 'true'); ?></h3></div>
                        <fieldset>
                        ...
                        <div align="center"><h3>STATISTIK TINGKAT GAJI ALUMNI<br><?php echo strtoupper($namaprogdi->progdi_name).' Periode '.$this->input->post('tahun1', 'true').' s/d '.$this->input->post('tahun2', 'true'); ?></h3></div>
                        <fieldset>
                            <div id="canvasgaji"></div>
                        </fieldset>
                        <div align="center"><h3>STATISTIK JENIS PERUSAHAAN<br><?php echo strtoupper($namaprogdi->progdi_name).' Periode '.$this->input->post('tahun1', 'true').' s/d '.$this->input->post('tahun2', 'true'); ?></h3></div>
                        <fieldset>
                            <div id="canvasjenis"></div>
                        </fieldset>
                        <div align="center"><h3>STATISTIK LAMA TUNGGU<br><?php echo strtoupper($namaprogdi->progdi_name).' Periode '.$this->input->post('tahun1', 'true').' s/d '.$this->input->post('tahun2', 'true'); ?></h3></div>
                        <fieldset>
