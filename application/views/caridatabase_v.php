<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-th"></i> Database Alumni
            </header>
            ...
            <div class="row">
                ...
                <section class="panel">
                    <header class="panel-heading">
                    Pilih Program Studi dan Periode Lulus
                    </header>
                                
                <div class="panel-body">
                <form class="form-horizontal tasi-form" action="<?php echo site_url('database/searchdata'); ?>" method="post" enctype="multipart/form-data">
