<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-bar-chart"></i> Cari Data Kuesioner
            </header>
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/lap_kuesioner/preview'); ?>" method="post" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">                                
                        <div class="input-group input-large">
                            <input type="text" class="form-control" id="tahun1" maxlength="4" name="tahun1" placeholder="Enter Tahun" autocomplete="off" required>
                            <span class="input-group-addon">s/d</span>
                            <input type="text" class="form-control" id="tahun2" maxlength="4" name="tahun2" placeholder="Enter Tahun" autocomplete="off" required>
                        </div>
                    </div>                   
                </div>                            
