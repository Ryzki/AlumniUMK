<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit Agenda
            </header>
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/agenda/updatedata'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control ckeditor" name="short" rows="6"><?php echo $agenda->agenda_short; ?></textarea>
                    </div>
                </div>
                ...
                <a href="<?php echo site_url('panel/agenda'); ?>" class="btn btn-info"><span class="glyphicon glyphicon-home"></span> Back </a>
