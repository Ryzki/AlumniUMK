<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit User 
            </header>
        ...
        <div class="row">
            ...
            <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/users/updatedata'); ?>" method="post" enctype="multipart/form-data">
