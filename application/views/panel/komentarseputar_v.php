<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-tasks"></i> Komentar Seputar Alumni List
            </header>
                ...
                <div class="panel-body">    	            
                    ...
                    <tr class="gradeA">
                        ...
                        <a href="<?php echo site_url('panel/komentar_seputar/deletedata/'.$r->komentar_id); ?>" OnClick="return confirm('Yakin Hapus Data Ini ?')" /><button class="btn btn-danger btn-xs" title="Delete"><i class="icon-trash "></i></button></a>
                        </td>                    
                    </tr>
                    <?php 
                        $no++; 
