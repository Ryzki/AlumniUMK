...
<div class="page">
  <div align="center">LAPORAN DATA ALUMNI</div>  
  <div align="center">UNIVERSITAS MURIA KUDUS</div>
  <br>
  <br>
  <table class="judul" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td align="center"><?php echo $p->alumni_tgl_lulus; ?></td>
      <td align="center"><?php echo $p->alumni_hp; ?></td>
      <td align="center"><?php echo $p->fakultas_name.' - '.$p->progdi_name; ?></td>
      <td align="center"><?php echo $p->kegiatan_desc; ?></td>
    </tr>
    <?php $no++; } ?>
  </table>
</div>
