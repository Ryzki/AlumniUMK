<section class="wrapper">	
    <div class="row">
        ...
        <i class="icon-plus-sign-alt"></i> Laporan Statistik Alumni : <b><?php if (!empty($namaprogdi->progdi_name)) { echo $namaprogdi->progdi_name; } else { echo "SEMUA PROGRAM STUDI"; } ?></b>
        </header>
