	...
	<div class="row">
    	<div class="col-lg-12">
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/wisuda/updatedata'); ?>" method="post" enctype="multipart/form-data">
                ...
                <a href="<?php echo site_url('panel/wisuda'); ?>" class="btn btn-info"><span class="glyphicon glyphicon-home"></span> Back </a>
