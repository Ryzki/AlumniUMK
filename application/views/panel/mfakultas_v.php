<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-cogs"></i> Fakultas List
            </header>
            	
                <div class="panel-body">
    	            <a href="<?php echo site_url('panel/mfakultas/addfakultas'); ?>"><button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span> Add</button></a>
                	<div class="adv-table">
