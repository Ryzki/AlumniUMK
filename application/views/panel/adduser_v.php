<section class="wrapper">
    <div class="row">
        ...
        <i class="icon-plus-sign-alt"></i> Form Add User
        </header>
        ...
        <div class="row">
            ...
            <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/users/savedata'); ?>" method="post" enctype="multipart/form-data">
