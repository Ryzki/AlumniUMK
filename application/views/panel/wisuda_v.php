            ...
            <i class="icon-th"></i> Wisuda List
                ...
                <div class="panel-body">    	            
                    ...
                    <tr class="gradeA">
                        ...
                        <a href="<?php echo site_url('panel/wisuda/editwisuda/'.$r->wisuda_id); ?>"><button class="btn btn-primary btn-xs" title="Check"><i class="icon-pencil"></i></button></a>
                        <a href="<?php echo site_url('panel/wisuda/deletedata/'.$r->wisuda_id).'/'.$r->alumni_nim; ?>" OnClick="return confirm('Yakin Hapus Data Ini ?')" /><button class="btn btn-danger btn-xs" title="Delete"><i class="icon-trash "></i></button></a>
                        </td>                    
                    </tr>
                    <?php 
                        $no++; 
