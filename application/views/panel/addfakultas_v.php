    ...
    <div class="row">
    	<div class="col-lg-12">
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/fakultas/savedata'); ?>" method="post">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                
                <div class="form-group">
                	<label class="control-label col-sm-2">Fakultas Title :</label>
                	<div class="col-sm-6 has-success">
                    <input type="text" name="title" class="form-control" id="title" placeholder="Enter Fakultas Title" value="<?php echo set_value('title'); ?>" autocomplete="off" required="true" autofocus>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="url" class="form-control" id="url" placeholder="Enter Fakultas URL" value="<?php echo set_value('url'); ?>" autocomplete="off" required="true">
                    </div>
