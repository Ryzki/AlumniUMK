<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-bar-chart"></i> Laporan Statistik Alumni
            </header>
            ...
            <div class="row">
                ...
                <section class="panel">
                    <header class="panel-heading">
                    Pilih Program Studi Alumni
                    </header>
                                
                <div class="panel-body">
                <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/lap_statistik/preview'); ?>" method="post" enctype="multipart/form-data">
