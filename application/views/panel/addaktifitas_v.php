<section class="wrapper">
    <div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-plus-sign-alt"></i> Form Add Aktifitas
            </header>
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/aktifitas/savedata'); ?>" method="post">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                
                <div class="form-group">
                	<label class="control-label col-sm-2">Aktifitas Desc :</label>
                	<div class="col-sm-6 has-success">
                    <input type="text" name="desc" class="form-control" id="desc" placeholder="Enter Aktifitas Desc" value="<?php echo set_value('desc'); ?>" autocomplete="off" required="true" autofocus>
                    </div>
