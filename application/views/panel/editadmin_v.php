<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit Admin 
            </header>
        ...
        <div class="row">
            ...
            <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/user_admin/updatedata'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            
            <div class="form-group">
            	<label class="control-label col-sm-2">Username :</label>
            	<div class="col-sm-6 has-success">
               <input type="text" name="username" class="form-control" id="username" placeholder="Enter Username" value="<?php echo $user->user_username; ?>" autocomplete="off" readonly="true" autofocus>
                </div>                
			</div>			 
            ...
            <div class="form-group">
            	...
            	<div class="col-sm-6 has-success">
               <input type="text" name="name" class="form-control" id="name" placeholder="Enter Name" value="<?php echo $user->user_name; ?>" autocomplete="off" required="true">
                </div>				
			</div>                       
            ...
            <div class="form-group">
                ...
                <?php } else { ?>
                <img src="<?php echo base_url().'avatar/'.$user->user_avatar; ?>" alt="" height="50" width="50" />
                <?php } ?>
                </div>
            </div>
