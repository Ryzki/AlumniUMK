<section class="wrapper">
    <div class="row">
        ...
        <div class="row">
            ...
            <form class="form-horizontal tasi-form" action="<?php echo site_url('panel/agenda/savedata'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <textarea class="form-control ckeditor" id="short" name="short" rows="6"><?php echo set_value('short'); ?></textarea>
                </div>
