...
<table class="judul" width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td width="18%" rowspan="2" class="judul" align="center"><?php if (!empty($detailwisuda->alumni_foto)) { ?><img src="<?php echo base_url(); ?>foto/<?php echo $detailwisuda->alumni_foto; ?>" height="120px" width="100px"  /><?php } else { ?><img src="<?php echo base_url(); ?>foto/no_photo.jpg" height="120px" width="100px" /><?php } ?></td>
  </tr>
  <tr>
...
<table class="judul" width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
  <tr>
    <td width="60%" class="judul">&nbsp;</td>
    <td width="40%" class="judul">
    <div align="center">Kudus, <?php echo tgl_indo(date('Y-m-d')); ?><br /><br /><br /><br /><br />( <b><?php echo $detailwisuda->alumni_nama; ?></b> )</div>
    </td>
  </tr>
</table>
