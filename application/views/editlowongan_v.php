<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit Lowongan Kerja
            </header>
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('lowongan/updatedata'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control" name="short" id="short" rows="6"><?php echo $lowker->lowker_short; ?></textarea>
                    </div>                
                </div>                
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datepicker"  size="16" type="text" value="<?php echo $lowker->lowker_tgl_deadline; ?>" name="tgl_deadline" id="tgl_deadline" />                                    
                    </div>
                </div>            
                ...
                <a href="<?php echo site_url('lowongan'); ?>" class="btn btn-info"><span class="glyphicon glyphicon-home"></span> Back </a>
