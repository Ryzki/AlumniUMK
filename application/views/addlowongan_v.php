<section class="wrapper">
    <div class="row">
        ...
        <div class="row">
            ...
            <form class="form-horizontal tasi-form" action="<?php echo site_url('lowongan/savedata'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datepicker" size="16" type="text" value="<?php echo date('Y-m-d'); ?>" name="tgl_deadline" id="tgl_deadline" />
                </div>
