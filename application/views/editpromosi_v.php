<section class="wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit Promosi
            </header>
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('promosi/updateusaha'); ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="usaha_id" value="<?php echo $usaha->usaha_id; ?>" />               
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">                            

                <div class="form-group">
                    <label class="control-label col-sm-2">Nama Usaha :</label>
                    <div class="col-sm-6 has-success">
                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Enter Nama Usaha" value="<?php echo $usaha->usaha_name; ?>" autocomplete="off" required="true">
                    </div>                
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Enter Alamat Usaha" value="<?php echo $usaha->usaha_alamat; ?>" autocomplete="off" required="true">
                    </div>                
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="web" class="form-control" id="web" placeholder="Enter Web Usaha" value="<?php echo $usaha->usaha_web; ?>" autocomplete="off" required>
                    </div>                
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="bidang" class="form-control" id="bidang" placeholder="Enter Bidang Usaha" value="<?php echo $usaha->usaha_bidang; ?>" autocomplete="off" required>
                    </div>                
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="jumlah" class="form-control" id="jumlah" placeholder="Enter Jumlah Karyawan" value="<?php echo $usaha->usaha_jml_karyawan; ?>" autocomplete="off" required>
                    </div>                
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="omzet" class="form-control" id="omzet" placeholder="Enter Omzet / Bulan" value="<?php echo $usaha->usaha_omzet; ?>" autocomplete="off" required>
                    </div>                
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">
                    <input type="text" name="pengeluaran" class="form-control" id="pengeluaran" placeholder="Enter Pengeluaran / Bulan" value="<?php echo $usaha->usaha_pengeluaran; ?>" autocomplete="off" required>
                    </div>                
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label col-sm-2">Logo</label>
                    <div class="col-sm-10">
                    <?php if (empty($usaha->usaha_logo)) { ?>
                       <img src="<?php echo base_url(); ?>img/no_image.gif" alt="" />
                    <?php } else { ?>
                       <img src="<?php echo base_url().'logo/'.$usaha->usaha_logo; ?>" alt="" height="150" width="150" />
                    <?php } ?>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-sm-2">Change Logo</label>
                    <div class="col-md-9">
