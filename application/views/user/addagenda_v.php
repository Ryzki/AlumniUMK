<section class="wrapper">
    <div class="row">
        ...
        <i class="icon-plus-sign-alt"></i> Form Add Agenda - <b><?php echo $progdi->progdi_name; ?></b>
        </header>
        ...
        <div class="row">
            ...
            <form class="form-horizontal tasi-form" action="<?php echo site_url('user/agenda/savedata/'.$this->uri->segment(4)); ?>" method="post" enctype="multipart/form-data">
