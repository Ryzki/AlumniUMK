<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit Wisudawan Baru
            </header>
            ...
            <div class="row">
                ...
                <section class="panel">
                    <header class="panel-heading">
                    Edit Data Wisudawan Baru
                    </header>
                    			
    			<div class="panel-body">
                <form class="form-horizontal tasi-form" action="<?php echo site_url('user/wisuda/updatedatabaru').'/'.$this->uri->segment(4); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 has-success">        
                    <input type="checkbox" name="chkProses" id="chkProses" value="Proses" required > Yes
                    </div>
                </div>
                ...
                <a href="<?php echo site_url('user/wisuda/baru').'/'.$this->uri->segment(4); ?>" class="btn btn-info"><span class="glyphicon glyphicon-home"></span> Back </a>
