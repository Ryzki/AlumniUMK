<section class="wrapper">
	<div class="row">
    	<div class="col-lg-12">
            ...
            <i class="icon-edit"></i> Form Edit Alumni Baru
            </header>
            ...
            <div class="row">
                ...
                <section class="panel">
                    <header class="panel-heading">
                    Edit Data Alumni Baru
                    </header>
                    			
    			<div class="panel-body">
                <form class="form-horizontal tasi-form" action="<?php echo site_url('user/alumni/updatedatabaru').'/'.$this->uri->segment(4); ?>" method="post" enctype="multipart/form-data">
                ...
                <a href="<?php echo site_url('user/alumni/baru/').'/'.$this->uri->segment(4); ?>" class="btn btn-info"><span class="glyphicon glyphicon-home"></span> Back </a>
