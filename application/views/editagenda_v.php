	...
	<div class="row">
    	<div class="col-lg-12">
            ...
            <div class="row">
                ...
                <form class="form-horizontal tasi-form" action="<?php echo site_url('agenda/updatedata'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control" name="short" id="short" rows="6"><?php echo $agenda->agenda_desc; ?></textarea>
                    </div>                
                </div>
                <div class="form-group">
