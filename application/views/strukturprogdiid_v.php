                    ...
                    <div class="row">
                        <div class="twelve columns b0">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-alt right"><a href="<?php echo base_url(); ?>">Beranda</a> &#187; Struktur Organisasi &#187; <?php echo $progdi->fakultas_name; ?> &#187; <?php echo $progdi->progdi_name; ?></div>
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">  
                        <div class="loop-posts eight columns">                            
                            ...
                            <div id="post-ID" class="post-CLASS blog-post-item b30">
                                ...
                                <h2 class="blog-title"><a href="<?php echo site_url().'strukturorganisasi/id/'.$s->struktur_id.'/'.$s->struktur_seo; ?>"><?php echo $s->struktur_title; ?></a></h2>
                                    <div class="blog-meta">                                                                                                                        
                                    </div>
                                </div>
                                <?php
                                    if (!empty($s->struktur_image)) {
                                ?>
                                <div class="blog-thumb-wrapper">
                                    <a href="<?php echo site_url().'strukturorganisasi/id/'.$s->struktur_id.'/'.$s->struktur_seo; ?>"><img src="<?php echo base_url(); ?>struktur/<?php echo $s->struktur_image; ?>" alt=""></a>
                                </div>
                                <?php
                                    }
                                ?>
